...
export const LoginButtons = () => {
    ...
    return (
        <div className="space-y-3 mb-6">
            <Button variant="social-dark" className="w-full" onClick={signinWithGoogle}>
            ...
            <Button variant="social-dark" className="w-full" onClick={signinWithGithub}>
            ...
            <Button variant="neon" className="w-full mt-4 pt-4">
                Log In
            </Button>
        </div>
    )
